                                ...
                                <div class="flex flex-col items-center justify-center text-center text-gray-600">
                                    <?php if(request('query')): ?>
                                        ...
                                        <p class="mt-2 text-gray-500">Tidak ada hasil untuk:
                                            <strong>"<?php echo e(request('query')); ?>"</strong>
                                        </p>
                                        <a href="<?php echo e(route('students')); ?>"
                    ...
                    <?php $__currentLoopData = $students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="*:text-gray-900 *:first:font-medium">
                            ...
                            <td class="px-3 py-2 whitespace-nowrap">
                                <a href="<?php echo e(route('student.detail', [
                                    'id' => $student->id,
                                    'name' => Str::slug($student->name),
                                ])); ?>"
                                    class="cursor-pointer hover:underline"><?php echo e($student->name); ?></a>
                            </td>
                            <td class="px-3 py-2 whitespace-nowrap"><?php echo e($student->absen); ?></td>
                            <td class="px-3 py-2 whitespace-nowrap">
                                <?php if($student->class && $student->class->id && $student->class->class_name): ?>
                                ...
                                <?php else: ?>
                                    <a href="<?php echo e(route('classes')); ?>" class="text-gray-500 italic hover:underline">
                                        -
                                    </a>
                                <?php endif; ?>
                            </td>
                            ...
                            <td class="px-3 py-2 whitespace-nowrap">
                                <span
                                    ...
                                    <a href="<?php echo e(route('delete.user', $student->id)); ?>" data-confirm-delete="true"
                                                ...
                                                <div class="grid grid-cols-2 gap-6 mt-4">
                                                    <div>
                                                        ...
                                                        <input id="no-kartu" type="text"
                                                            ...
                                                            class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md focus:outline-none"
                                                            name="card_number" value="<?php echo e($student->card_number); ?>"
                                                            required>
                                                    </div>
                                                        ...
                                                        <select id="class_name"
                                                            ...
                                                            <?php $__currentLoopData = $classes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $class): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option value="<?php echo e($class->id); ?>" 
                                                                    <?php echo e(optional($student->class)->id == $class->id ? 'selected' : ''); ?>>
