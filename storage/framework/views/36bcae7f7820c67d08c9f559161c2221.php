    ...
    <div class="p-5 ml-17 sm:ml-64 flex flex-col gap-4">
        <div class="bg-white shadow-lg p-6 rounded-lg lg:w-2/5 flex justify-between items-center">
            <label for="mode_name">
                ...
                <p class="text-gray-800 font-mono font-bold">=> <?php echo e(ucfirst($mode->mode_name)); ?></p>
            </label>
        ...
        <div class="bg-white shadow-lg p-6 rounded-lg lg:w-2/5 flex justify-between items-center">
            <label for="absen_mode">
                ...
                <p class="text-gray-800 font-mono font-bold">=> <?php echo e(strtoupper($mode->absen_mode)); ?></p>
            </label>
            <form action="<?php echo e(route('mode')); ?>" method="POST">
                <?php echo csrf_field(); ?>
            ...
            <div class="sm:flex justify-between">
                <div class="flex flex-col gap-2 mt-2">
                    <div class="flex gap-2 items-center flex-wrap">
                        ...
                        <span
                            class="border border-black p-1 rounded-lg text-gray-800 font-mono font-bold"><?php echo e($timeLimit?->in ? date('H:i', strtotime($timeLimit->in)) : '-'); ?>
                    ...
                    <div class="flex gap-2 items-center flex-wrap">
                        ...
                        <span
                            class="border border-black p-1 rounded-lg text-gray-800 font-mono font-bold"><?php echo e($timeLimit?->out ? date('H:i', strtotime($timeLimit->out)) : '-'); ?>
