...
@section('content')
    <div class="p-5 ml-17 sm:ml-64">
        ...
        <h1 class="text-2xl text-center font-bold mb-4">Siswa dengan Status {{ $status->status_name }}</h1>
            ...
            <table class="min-w-full divide-y-2 divide-gray-200">
                <thead class="ltr:text-left rtl:text-right">
                    <tr class="*:font-medium *:text-gray-900">
                        ...
                        <th class="px-4 py-2 whitespace-nowrap">Kelas</th>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @if ($students->isEmpty())
                        <tr>
                            <td colspan="7" class="py-12 whitespace-nowrap">
                                <div class="flex flex-col items-center justify-center text-center text-gray-600">
                                    ...
                                    <h2 class="text-lg font-semibold text-gray-800 mt-1">Belum ada siswa dengan status
                                        kehadiran ini.</h2>
                                </div>
                            </td>
                        </tr>
                    ...
                    @foreach ($students as $student)
                        <tr class="*:text-gray-900 *:first:font-medium">
                            ...
                            <td class="px-4 py-2 whitespace-nowrap">{{ $student->telepon }}</td>
                            <td class="px-4 py-2 whitespace-nowrap">
                                <span
