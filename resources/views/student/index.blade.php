        ...
        <div class="flex flex-col md:flex-row md:justify-center md:space-x-8 space-y-8 md:space-y-0">
            <div class="bg-white rounded-2xl shadow-lg border border-gray-200 md:w-2/4 w-full overflow-hidden pb-2">
                <div class="p-5 border-b border-gray-200 flex items-center justify-between">
                    ...
                    <span
                        ...
                        {{ $mode->absen_mode === 'manual' ? 'bg-emerald-100 text-emerald-700' : 'bg-gray-100 text-gray-600' }}">
                        Mode: {{ strtoupper($mode->absen_mode) }}
                    </span>
                </div>
                        ...
                        <tbody class="divide-y divide-gray-100">
                            @forelse ($attendances as $attendance)
                                <tr class="hover:bg-emerald-50 transition">
                                    ...
                                    <td class="px-3 py-2 whitespace-nowrap font-medium">{{ $attendance->student->name }}
                                    </td>
            ...
            <div
                ...
                @if ($mode->absen_mode === 'manual')
                    ...
                    <form action="{{ route('student.manual.absen') }}" method="POST">
                        @csrf
                        <button type="submit"
