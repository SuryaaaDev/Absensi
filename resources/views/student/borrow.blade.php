...
@section('content')
    <div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-emerald-50 via-white to-green-50">
        <div class="text-center px-6 relative">
            <div class="absolute -top-10 left-1/2 -translate-x-1/2 w-24 h-1 bg-indigo-500 rounded-full animate-pulse"></div>

            <h1 class="text-4xl md:text-6xl font-extrabold text-gray-900 mb-4 tracking-tight animate-fadeIn">
                🚀 Fitur Peminjaman Alat
            </h1>

            <p class="text-lg md:text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed animate-fadeIn delay-200">
                Kami sedang menyiapkan sistem peminjaman alat agar lebih mudah, modern,
                dan terorganisir. Nantikan peluncurannya segera!
            </p>

            <p class="mt-8 text-xl md:text-2xl font-semibold text-indigo-600 animate-blink">
                Segera Hadir
            </p>
        </div>
    </div>
...
{{-- <section class="w-3/4 md:w-1/2 m-auto bg-white border divide-y rounded divide-slate-200 border-slate-200">
    ...
    <details class="p-4 group">
        ...
        <p class="mt-4 text-slate-500">
            Jika Anda tidak dapat hadir, silakan gunakan menu "<a href="/permission"
                class="underline decoration-solid font-semibold hover:text-slate-400">Perizinan</a>" di website ini
            untuk mengajukan izin dengan
            langkah berikut:
        <ul class="list-disc mx-4 text-slate-500">
            <li>Isi nama lengkap, kelas, nomor telepon, dan email aktif <span class="font-semibold">(akan terisi
                    otomatis dan tidak bisa di ubah).</span></li>
    ...
    <details class="p-4 group">
        <summary
            class="[&::-webkit-details-marker]:hidden relative flex gap-4 pr-8 font-medium list-none cursor-pointer text-slate-700 focus-visible:outline-none transition-colors duration-300 group-hover:text-slate-900 ">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 text-blue-500 shrink-0" viewBox="0 0 16 16">
