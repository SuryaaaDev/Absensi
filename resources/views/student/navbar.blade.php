            ...
            <div class="flex justify-center items-center">
                <div x-data="{ open: false }">
                    ...
                    <section x-show="open" x-collapse
                        ...
                        <ul>
                            <li>
                                <a class="flex items-center justify-start gap-2 p-2 px-3.5 transition-colors duration-300 text-slate-500 hover:bg-emerald-50 hover:text-emerald-500 {{ request()->is('profile*') ? 'bg-emerald-50 text-emerald-500 outline-none' : '' }}"
                                    href="/profile">
                                    ...
                                    <div
                                        class="flex flex-col {{ request()->is('profile*') ? 'text-emerald-500' : '' }}">
                                        <span class="leading-5 truncate">{{ \Illuminate\Support\Str::limit(Auth::user()->name, 25, '...') }}</span>
                                        <span class="leading-5 truncate">{{ \Illuminate\Support\Str::limit(Auth::user()->email, 20, '...')  }}</span>
                                    </div>
                                </a>
                            </li>
                            <hr>
                            <li>
                                <a class="flex items-start justify-start gap-2 p-2 px-5 transition-colors duration-300 text-slate-500 hover:bg-emerald-50 hover:text-emerald-500 {{ request()->is('student*') ? 'bg-emerald-50 text-emerald-500 outline-none' : '' }}"
                                    href="{{ route('student') }}">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                        class="flex-shrink-0 w-5 h-5 {{ request()->is('student*') ? 'text-emerald-500' : '' }}"
                                    ...
                                    <span
                                        class="leading-5 truncate {{ request()->is('student*') ? 'text-emerald-500' : '' }}">Data
                                        Absen</span>
                                </a>
                            </li>
                            <li>
                                <a class="flex items-start justify-start gap-2 p-2 px-5 transition-colors duration-300 text-slate-500 hover:bg-emerald-50 hover:text-emerald-500 {{ request()->is('history*') ? 'bg-emerald-50 text-emerald-500 outline-none' : '' }}"
                                    href="{{ route('history') }}" aria-current="page">
                                    <svg class="flex-shrink-0 w-5 h-5 {{ request()->is('history*') ? 'text-emerald-500' : '' }}"
                                    ...
                                    <span
                                        class="leading-5 truncate {{ request()->is('history*') ? 'text-emerald-500' : '' }}">History</span>
                                </a>
                            </li>
                            <li>
                                <a class="flex items-start justify-start gap-2 p-2 px-5 transition-colors duration-300 text-slate-500 hover:bg-emerald-50 hover:text-emerald-500 {{ request()->is('permission*') ? 'bg-emerald-50 text-emerald-500 outline-none' : '' }}"
                                    href="{{ route('permission') }}">
                                    <svg xmlns="http://www.w3.org/2000/svg"
                                        class="flex-shrink-0 w-5 h-5 {{ request()->is('permission*') ? 'text-emerald-500' : '' }}"
                                        viewBox="0 0 16 16">
                                        <path fill="currentColor"
                                            d="M0 1.75C0 .784.784 0 1.75 0h12.5C15.216 0 16 .784 16 1.75v9.5A1.75 1.75 0 0 1 14.25 13H8.06l-2.573 2.573A1.458 1.458 0 0 1 3 14.543V13H1.75A1.75 1.75 0 0 1 0 11.25Zm1.75-.25a.25.25 0 0 0-.25.25v9.5c0 .138.112.25.25.25h2a.75.75 0 0 1 .75.75v2.19l2.72-2.72a.749.749 0 0 1 .53-.22h6.5a.25.25 0 0 0 .25-.25v-9.5a.25.25 0 0 0-.25-.25Zm7 2.25v2.5a.75.75 0 0 1-1.5 0v-2.5a.75.75 0 0 1 1.5 0ZM9 9a1 1 0 1 1-2 0a1 1 0 0 1 2 0Z" />
                                    </svg>
                                    <span
                                        class="leading-5 truncate {{ request()->is('permission*') ? 'text-emerald-500' : '' }}">Perizinan</span>
                                </a>
                            </li>
                            <li>
                                <a class="flex items-start justify-start gap-2 p-2 px-5 transition-colors duration-300 text-slate-500 hover:bg-emerald-50 hover:text-emerald-500 {{ request()->is('borrow*') ? 'bg-emerald-50 text-emerald-500 outline-none' : '' }}"
                                    href="{{ route('borrow') }}">
                                    <svg xmlns="http://www.w3.org/2000/svg"
                                        class="flex-shrink-0 w-5 h-5 font-bold {{ request()->is('borrow*') ? 'text-emerald-500' : '' }}"
                                        viewBox="0 0 512 512">
                                    ...
                                    <span
                                        class="leading-5 truncate {{ request()->is('borrow*') ? 'text-emerald-500' : '' }}">Peminjaman</span>
                                </a>
                            </li>
                            <hr>
                            <li>
